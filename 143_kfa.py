...
lyrics = [
    ...
    ("If the whole world shuts you out", 0.07, Fore.LIGHTYELLOW_EX),
    ("I'm not gonna run", 0.1, Fore.GREEN),
    ("If you mess it up, I'll be the one", 0.05, Fore.LIGHTCYAN_EX),
    ("Be the first to let you live it down", 0.08, Fore.RED),
]
